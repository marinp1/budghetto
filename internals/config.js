...
const Budghetto = {
  ...
  dllPlugin: {
    defaults: {
      ...
      path: resolve('../node_modules/budghetto-dlls'),
    },

    entry(pkg) {
      const dependencyNames = Object.keys(pkg.dependencies);
      const exclude = pkg.dllPlugin.exclude || Budghetto.dllPlugin.defaults.exclude;
      const include = pkg.dllPlugin.include || Budghetto.dllPlugin.defaults.include;
